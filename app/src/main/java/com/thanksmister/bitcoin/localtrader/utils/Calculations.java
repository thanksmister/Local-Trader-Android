...
public class Calculations
{
    ...
    public static double calculateBTC(double editARS, double defaultARS)
    {
        double btcValue;
        String btc;
        btcValue = editARS / defaultARS;
        btc = Conversions.formatBitcoinAmount(btcValue);
       
        return Doubles.convertToDouble(btc);
    }

    public static double calculateBTCFromUSD(double btcUSD, double usd)
    {
        double btcValue;
        String btc;
        btcValue = usd / btcUSD;
    ...
    {
        CalculatedValue fees = Calculations.calculateFees(feeAmount, btcValue, arsValue, usdValue);
        CalculatedValue sales = Calculations.calculateSale(saleAmount, btcValue, arsValue, usdValue);
        CalculatedValue commission = Calculations.calculateCommission(commissionAmount, btcValue, arsValue, usdValue);
    ...
    public static CalculatedValue calculateSale(double saleAmount, double btcValue, double arsValue, double usdValue)
    {
        ...
        double btcSale = Calculations.calculateSaleBTC(saleAmount, arsValue, btcValue);
        double usdSale = Calculations.calculateUSDValue(usdValue, btcSale);
    ...
    public static CalculatedValue calculateFees(double feeAmount, double btcValue, double arsValue, double usdValue)
    {
        ...
        double arsSale = Calculations.calculateSaleARS(arsValue, feeValue);
        double usdSale = Calculations.calculateUSDValue(usdValue, feeValue);
