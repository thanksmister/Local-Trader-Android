 ...
 */
public class MethodsTypeAdapterFactory implements TypeAdapterFactory
{
    @Override
            ...
            public T read(JsonReader in) throws IOException
            {
                ...
                if (jsonElement.isJsonObject()) {
                    ...
                    if (jsonObject.has("data") && jsonObject.get("data").isJsonObject()) {
                        ...
                        if (dataObject.has("methods") && dataObject.get("methods").isJsonObject()) {
                            currencyObject = dataObject.getAsJsonObject("methods");
                        }
